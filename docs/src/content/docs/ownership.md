...
description: "Copy and move rules, borrow lifetimes, borrowed returns, and cleanup in Dodo 0.1.1."
section: "Language reference"
order: 220
---

These are the ownership rules and checker limits implemented in Dodo 0.1.1.
