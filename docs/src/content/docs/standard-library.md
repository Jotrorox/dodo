...
| [Web serving](web.md) | `std/web`, `std/web/hosted`, `std/web/response`, `std/web/server`, `std/web/static_files`, `std/web/stream` | Routing/composition portable; hosted/static files explicit. |
