...
- [Web applications](https://jotrorox.github.io/dodo/web/): register named handlers and run a server with bounded default storage; see [the multi-route example](examples/web_routes.dodo).
