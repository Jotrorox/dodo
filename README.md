...
- [Standard library](https://jotrorox.github.io/dodo/standard-library/): portable core, explicit allocation, byte I/O, formatting, UTF-8 text, collections, mathematics, hashing, and time.
